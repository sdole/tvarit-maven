...
@Deprecated
/**
 * @deprecated to be removed in version 1.0.0
 */
public class InfrastructureMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        getLog().warn("This goal has been deprecated and may be removed without notice. Please use the goal 'make-infrastructure' instead.");
